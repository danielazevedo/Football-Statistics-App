//acede ao return do getInfo
 app.controller('homeController', ['$scope', '$route','getInfoHome', 'getInfoAway','getInfoTotal', 'getPrevGames', 'sharedProperties', function ($scope, $route, getInfoHome, getInfoAway, getInfoTotal, getPrevGames, sharedProperties) {
      ...
      $scope.setActiveTab = function(tabToSet) {
            ...
            if(tabToSet == 1){
                  ...
                  if(cache[0] == 0){
                        getInfoTotal.make_request($scope.team1).success(function(data){
                              console.log(data);
                              handleData(data);
                              cache[0] = data;
                        });
            ...
            //home
                  ...
                  if(cache[1] == 0){
                        getInfoHome.make_request($scope.team1).success(function(data1){
                              console.log(data1);
                              handleData(data1);
                              cache[1] = data1;
                        });
            ...
            //away
                  ...
                  if(cache[2] == 0){
                        getInfoAway.make_request($scope.team1).success(function(data2){
                              console.log(data2);
                              handleData(data2);
                              cache[2] = data2;   
